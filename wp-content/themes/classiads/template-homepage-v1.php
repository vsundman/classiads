...
<?php if($page_slider  != "Big Map" && $page_slider != "LayerSlider") { ?>
	...
	<section id="custom-ads">
		...
		$homeAdCode1 = $redux_demo['home_ad_code_client1']; 
		$homeAdCodeslot1 = $redux_demo['home_ad_code_slot1']; 
		$homeAdCodewidth1 = $redux_demo['home_ad_code_width1']; 
		$homeAdCodeheight1 = $redux_demo['home_ad_code_height1']; 
		...
		$homeAdCode2 = $redux_demo['home_ad_code_client2']; 
		$homeAdCodeslot2 = $redux_demo['home_ad_code_slot2']; 
		$homeAdCodewidth2 = $redux_demo['home_ad_code_width2']; 
		$homeAdCodeheight2 = $redux_demo['home_ad_code_height2']; 
	...
	<?php 
		$home_cat_disable = $redux_demo['home-cat-disable'];

	?>

	<?php if($home_cat_disable == 1) { ?>
	...
	global $wp_rewrite;
		...
		$cat_counter = $redux_demo['home-ads-view'];
		if(isset($_GET['view-type'])){
				 $current_view_type = $_GET['view-type'];
			}else{
				 $current_view_type = $cat_counter;
		}   
