				...
				<div id="upload-ad" class="ad-detail-content">
					...
					<form class="form-item" action="" id="primaryPostForm" method="POST" enctype="multipart/form-data">
						...
						<?php } ?>
							...
							<input type="text" id="postTitle" name="postTitle" placeholder="<?php _e('Ad Title Goes here |', 'agrg') ?>" size="60" maxlength="255" class="form-text required input-textarea half">
						...
						<div class="clearfix"></div>
							...
							<?php
								...
								<option value="Not Provided"><?php _e('Select Location', 'agrg'); ?></option>
								<?php
							...
							<label for="edit-field-category-und" class="control-label"><?php _e('Ad Type', 'agrg') ?></label>
								...
								<div class="field-type-list-boolean field-name-field-featured field-widget-options-onoff form-wrapper" id="edit-field-featured">
									...
									<?php if($featuredADS == "0" || empty($result)){ ?>
										<p><?php _e('Currently you have no active plan for featured ads. You must purchase a', 'agrg') ?> <a href="<?php echo $featured_plans; ?>" target="_blank"><?php _e('Featured Pricing Plan', 'agrg') ?></a> <?php _e('to be able to publish a Featured Ad.', 'agrg') ?></p>
										<?php } }?>
