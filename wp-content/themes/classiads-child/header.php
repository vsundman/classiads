...
<head>
	...
	<!-- FONTS -->
<script src="//use.typekit.net/iqm0agx.js"></script>
		...
		<div class="container">
			...
			<section id="register-login-block-top">
				<ul class="ajax-register-links inline">
					...
					<span> | </span>
							<li class="first">
						<a href="<?php echo $register; ?>" class="ctools-use-modal ctools-modal-ctools-ajax-register-style" title="Register"><?php printf( __( 'Register', 'heman' )); ?></a>
					</li>
				<?php } ?>
				</ul>  
			</section>
